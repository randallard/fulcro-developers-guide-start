     ...
     {:list/id     id
      ...
      :list/people (if (= id :friends)
                    [(comp/get-initial-state Person {:id 1 :name "Sally" :age 32})
                     (comp/get-initial-state Person {:id 2 :name "Joe" :age 31})]
                    [(comp/get-initial-state Person {:id 3 :name "Jack" :age 33})
                     (comp/get-initial-state Person {:id 4 :name "Jill" :age 34})])})}
